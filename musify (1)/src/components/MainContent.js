        ...
        <div className="pianoImageContainer">
          ...
          <div className="imageIcons">
            ...
            <div className="microphoneCircle">
              <MicIcon className="microphoneIcon" />
            </div>
          </div>
      ...
      <div className="smallWhiteCards">
        <div className="whiteCardSmall">
          <div className="cardImageContainer">
            <img
              src="https://i.pinimg.com/564x/91/7d/ce/917dceb8f06724e76b770d76924b3791.jpg"
              alt="Microphone"
              className="cardImage"
            />
            <div className="microphoneCircle">
        ...
        <div className="whiteCardSmall">
          <div className="cardImageContainer">
            <img
              src="https://i.pinimg.com/564x/a7/9d/ff/a79dff90774dd22b5bc2117aa31990f0.jpg"
              alt="Microphone"
              className="cardImage"
            />
            <div className="microphoneCircle">
        ...
        <div className="whiteCardSmall">
          <div className="cardImageContainer">
            <img
              src="https://i.pinimg.com/564x/9d/bd/6b/9dbd6b63b448de4638de3ce215b32176.jpg"
              alt="Microphone"
              className="cardImage"
            />
            <div className="microphoneCircle">
